...
const Login = () => {
    ...
    const {backendURL, setIsLoggedin} = useContext(AppContext); /* add this in main or App.js file */
    ...
    return (
        ...
        <ToastContainer/>
            ...
            <p className="p">Don't have a account? <span className="span"><Link to='/signup'>Sign Up</Link></span></p>
